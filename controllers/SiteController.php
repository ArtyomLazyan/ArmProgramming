<?php
    class SiteController {
        public function actionIndex()
        {
            ...
            $topRatesArticles = Article::topRatesArticles(4);
            ...
            $title = "Սովորեք ծրագրավորում զրոյից";
        ...
        public function actionAbout()
        {
            ...
            $title = "Title for main page About";
            $description = "Description for main page About";
        ...
        public function actionContact()
        {
            ...
            $title = "Title for main page COntact";
            $description = "Description for main page COntact";
