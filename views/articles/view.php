...
<div class="content_bottom">
  <div class="col-lg-8 col-md-8">
      ...
      <div class="single_page_area">
        ...
        <div class="single_page_content">
          <div class="post_commentbox">
            ...
            <?php if (!isset($article["video_iframe"])) : ?>
    ...
    <div class="post_pagination">
      <div class="prev"> <a class="angle_left" href="/article/<?=$previosArticle["id"]; ?>"><i class="fa fa-angle-double-left"></i></a>
        <div class="pagincontent"> <span>Previous Post</span> <a href="/article/<?=$previosArticle["id"]; ?>"><?=$previosArticle["title"]; ?></a> </div>
      </div>
      <div class="next">
        <div class="pagincontent"> <span>Next Post</span> <a href="/article/<?=$nextArticle["id"]; ?>"><?=$nextArticle["title"]; ?></a> </div>
        <a class="angle_right" href="/article/<?=$nextArticle["id"]; ?>"><i class="fa fa-angle-double-right"></i></a> </div>
    </div>
