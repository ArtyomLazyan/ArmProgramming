      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="content_middle_middle">
          <div class="slick_slider2">
             <?php foreach ($topRatesArticles as $topArticles) : ?>
            ...
            <div class="business_category_left wow fadeInDown">
              <ul class="fashion_catgnav clearfix">
                <li>
                  ...
                  <p class="pull-left"><?php echo substr($category3[0]["text"], 0, 100); ?>......</p>
                </li>
              </ul>
            </div>
              ...
              <div class="single_category">
                ...
                <ul class="fashion_catgnav wow fadeInDown clearfix">
                    <li>
                      ...
                      <p class="pull-left"><?php echo substr($category4[0]["text"], 0, 100); ?>......</p>
                    </li>
                </ul>
                ...
                <div class="single_category wow fadeInDown">
                  ...
                  <ul class="fashion_catgnav wow fadeInDown clearfix">
                      <li>
                        ...
                        <p class="pull-left"><?php echo substr($category5[0]["text"], 0, 100); ?>......</p>
                      </li>
                  </ul>
                  <ul class="small_catg wow fadeInDown">
              ...
              <div class="business_category_left">
                <ul class="fashion_catgnav wow fadeInDown clearfix">
                    <li>
                      ...
                      <p class="pull-left"><?php echo substr($category6[0]["text"], 0, 100); ?>......</p>
                    </li>
                </ul>
              </div>
